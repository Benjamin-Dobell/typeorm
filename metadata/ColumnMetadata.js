...
var ColumnMetadata = /** @class */ (function () {
    ...
    ColumnMetadata.prototype.compareEntityValue = function (entity, valueToCompareWith) {
        ...
        if (this.entityMetadata.connection.driver instanceof CockroachDriver_1.CockroachDriver && this.entityMetadata.connection.driver.normalizeType({ type: this.type }) === "int8") {
