...
var WhereFactory_1 = require("./WhereFactory");
...
var QueryBuilder = /** @class */ (function () {
    ...
    QueryBuilder.prototype.computeWhereParameter = function (where) {
        ...
        if (typeof where === "string")
            return where;
        if (where instanceof WhereFactory_1.WhereFactory) {
            ...
            return whereString ? (where instanceof Brackets_1.Brackets ? "(" + whereString + ")" : whereString) : "";
        }
